...
public class TopicValidator {
    ...
    public static final String RMQ_SYS_SCHEDULE_TOPIC = "SCHEDULE_TOPIC_XXXX";//延时消息得topic?
    public static final String RMQ_SYS_BENCHMARK_TOPIC = "BenchmarkTest";//用于压测
    public static final String RMQ_SYS_TRANS_HALF_TOPIC = "RMQ_SYS_TRANS_HALF_TOPIC";//用于事务
    public static final String RMQ_SYS_TRACE_TOPIC = "RMQ_SYS_TRACE_TOPIC";//用于跟踪消息
    ...
    public static final String RMQ_SYS_OFFSET_MOVED_EVENT = "OFFSET_MOVED_EVENT"; //广播消费模式使用的topic
